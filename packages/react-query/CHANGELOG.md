...
- 724b47a: Polish package metadata and per-package READMEs.
...
- Updated dependencies [724b47a]
  - @zerovoids/http@0.1.2

## 0.1.1

### Patch Changes

- 9928264: Verify trusted-publishing end-to-end publish pipeline (no functional change).
- Updated dependencies [9928264]
  - @zerovoids/http@0.1.1
